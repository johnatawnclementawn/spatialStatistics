---
title: "Spatial Statistics HW3"
author: "Johnathan Clementi, Xiong Zheng, Lan Xiao"
date: "11/16/2021"
output: 
  html_document:
    theme: journal
...
mydata <- read.csv("D:/OneDrive/WORK/Upenn/MUSA_500_Spatial_Statistics_Data_Analysis_Eugene/HW_Assignments/HW3/Homework_Assignments_export/HW 3/Logistic Regression Data.csv")
head(mydata)
```
...
#Cross-Tabulations
```{r}
#table(mydata$COLLISION_[mydata$DRINKING_D == 1])


#test <- CrossTable(mydata$COLLISION_, mydata$DRINKING_D, prop.r=FALSE, prop.t=FALSE, prop.chisq=FALSE, chisq=TRUE)[3]
...
```{r}
fit.binary = (fit>=0.02)
CrossTable(fit.binary, mydata$DRINKING_D, prop.r=FALSE, prop.t=FALSE, prop.c=FALSE, prop.chisq=FALSE)
